package com.joseibarra.touristnotify.firestore

import com.google.firebase.firestore.FirebaseFirestoreException
import com.joseibarra.touristnotify.base.FirestoreEmulatorTest
...
class FirestoreSecurityRulesTest : FirestoreEmulatorTest() {
    ...
    @Test
    fun `non-admin user cannot write to lugares_turisticos`() = runTest {
    ...
    @Test
    fun `unauthenticated user cannot read another user's data`() = runTest {
        auth.signOut()
