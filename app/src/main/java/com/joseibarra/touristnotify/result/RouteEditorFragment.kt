...
import com.joseibarra.touristnotify.databinding.FragmentRouteEditorBinding
import com.joseibarra.touristnotify.databinding.ItemRouteStopEditorBinding
import com.joseibarra.touristnotify.model.GeneratedRoute
import com.joseibarra.touristnotify.model.RouteStop
import com.joseibarra.touristnotify.routegen.RouteOptimizer
...
class RouteEditorFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.fabAgregarLugar.setOnClickListener {
            Snackbar.make(binding.root, "Selección de lugares disponible en la próxima versión", Snackbar.LENGTH_SHORT).show()
        }
    }
    ...
    private fun removeStop(position: Int) {
        if (stops.size <= 2) {
            Snackbar.make(binding.root, "La ruta debe tener al menos 2 paradas", Snackbar.LENGTH_SHORT).show()
            return
        }
