...
object RouteShareUrlBuilder {
    ...
    fun buildShareText(
        ...
        appendLine("🗺️ *${route.resumen.titulo.ifBlank { "Mi ruta en Álamos" }}*")
        ...
        if (mapsUrl != null) {
            appendLine("📍 Google Maps: $mapsUrl")
        }
        appendLine("🔗 Enlace LUPITA: $DEEP_LINK_BASE/${route.id}")
    }
