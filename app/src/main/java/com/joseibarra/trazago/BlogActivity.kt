...
import com.joseibarra.trazago.databinding.ActivityBlogBinding
...
class BlogActivity : BaseActivity() {
        ...
        lifecycleScope.launch {
            if (AuthManager.isAdmin()) {
                ...
                binding.fabAddPost.setOnClickListener {
                    startActivity(Intent(this@BlogActivity, AdminBlogActivity::class.java))
                }
            }
        }
    }
    ...
    private fun setupUI() {
        ...
        binding.blogRecyclerView.itemAnimator = MotionHelper.fadeSlideItemAnimator()
