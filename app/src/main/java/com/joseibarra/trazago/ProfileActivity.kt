...
import com.joseibarra.trazago.databinding.ActivityProfileBinding
...
class ProfileActivity : BaseActivity() {
    ...
    private fun uploadProfilePhoto(uri: Uri) {
        ...
        NotificationHelper.info(binding.root, getString(R.string.uploading_photo))
        lifecycleScope.launch {
            profileRepository.uploadPhoto(uid, uri)
                .onSuccess { downloadUrl ->
                    loadProfilePhoto(downloadUrl)
                    NotificationHelper.success(binding.root, getString(R.string.profile_photo_updated))
                }
                .onFailure { e ->
                    NotificationHelper.error(binding.root, getString(R.string.profile_photo_upload_error, e.message))
                }
        }
    }
    ...
    private fun loadStatistics() {
        ...
        lifecycleScope.launch {
            ...
            binding.aiUsageText.text = getString(R.string.ai_usage_format, usageStats.routesUsedToday, usageStats.routesLimitToday)
