...
class TrazaGoApplication : MultiDexApplication() {
    ...
    override fun onCreate() {
        ...
        applicationScope.launch {
            ConfigManager.initialize(this@TrazaGoApplication)
        }
    }
    ...
    companion object {
        fun setDarkMode(context: android.content.Context, enabled: Boolean) {
            val prefs = context.getSharedPreferences("TrazaGoPrefs", MODE_PRIVATE)
