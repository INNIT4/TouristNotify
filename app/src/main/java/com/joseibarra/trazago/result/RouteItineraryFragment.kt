...
import com.joseibarra.trazago.databinding.FragmentRouteItineraryBinding
...
class RouteItineraryFragment : Fragment() {
    ...
    private fun loadData() {
        ...
        binding.tvRutaTitulo.text = route.resumen.titulo.ifBlank { getString(R.string.route_your_route) }
