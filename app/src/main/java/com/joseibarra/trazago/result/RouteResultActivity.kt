...
import com.joseibarra.trazago.databinding.ActivityRouteResultBinding
...
class RouteResultActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        applyWindowInsets(binding.bottomNav, applyTop = false, applyBottom = true)

        setSupportActionBar(binding.toolbar)
        supportActionBar?.setDisplayHomeAsUpEnabled(true)
        supportActionBar?.title = currentRoute.resumen.titulo.ifBlank { getString(R.string.route_your_route) }
